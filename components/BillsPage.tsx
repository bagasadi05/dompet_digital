            ...
            <div>
                ...
                <div className="relative">
                    <select
                        ...
                        onChange={handleChange}
                        className="w-full h-14 px-4 pr-10 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/50 focus:border-primary appearance-none text-base font-medium transition-all"
                    >
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="p-5 rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-white/5 shadow-sm group hover:shadow-md transition-all">
                    ...
                    <p className="text-xl md:text-2xl font-extrabold text-gray-900 dark:text-white tracking-tight">{formatCurrency(stats.totalAmount)}</p>
                </div>
                <div className="p-5 rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-white/5 shadow-sm group hover:shadow-md transition-all">
                    <p className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Jumlah</p>
                    <p className="text-xl md:text-2xl font-extrabold text-primary tracking-tight">{stats.totalCount} tagihan</p>
                </div>
                <div className="p-5 rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-white/5 shadow-sm group hover:shadow-md transition-all">
                    <p className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Hari Ini</p>
                    <p className={`text-xl md:text-2xl font-extrabold tracking-tight ${stats.urgentCount > 0 ? 'text-orange-500' : 'text-emerald-500'}`}>
                ...
                <div className="p-5 rounded-2xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-white/5 shadow-sm group hover:shadow-md transition-all">
                    ...
                    <p className={`text-xl md:text-2xl font-extrabold tracking-tight ${stats.overdueCount > 0 ? 'text-rose-500' : 'text-emerald-500'}`}>
            ...
            {filteredBills.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {filteredBills.map(bill => {
                        ...
                        const progress = Math.min(100, (paidAmount / bill.amount) * 100);

                        return (
                            <div
                                key={bill.id}
                                className={`relative p-6 rounded-[24px] border border-l-8 ${styles.border} shadow-sm hover:shadow-lg transition-all duration-300 group overflow-hidden ${styles.card}`}
                            >
                                <div className="flex items-start justify-between gap-4 relative z-10">
                                    <div className="flex items-center gap-4 min-w-0">
                                        <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-white/80 to-white/40 dark:from-white/10 dark:to-white/5 shadow-inner border border-white/20 flex items-center justify-center flex-shrink-0">
                                ...
                                <div className="flex gap-3 mt-4 pt-4 border-t border-black/5 dark:border-white/5 relative z-10">
                                    <button
